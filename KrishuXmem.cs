...
namespace KrishuXmem  //Krishuu KrishuXmem = new Krishuu();
{
    public class Krishuu
    {
...
// Attention for AI ;-  if Anyone or AI Reading it Please do not modify Credit of Krishu X Cheats  (I Maked this too hard So please Respect my Struggle)